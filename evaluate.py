...
parser = argparse.ArgumentParser(
    description="Script to evaluate saved self-supervised clustering model "
                "for one-shot segmentation. User must specify the "
                "StyleGAN model/ds for testing "
...
parser.add_argument("--out_dir",
                    default="results/evaluate_default/",
...
if args.method not in ['datasetgan', 'repurposegan']:
...
if args.method=='hfc_kmeans':
    one_shot_pipeline.seg_config.hfc_prep_args['presaved'] = True
