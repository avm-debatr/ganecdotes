...
sample_latents = ROOT_DIR + '/checkpoints/baggan/pidray_wrench_256/latents.pt'
sample_images = ROOT_DIR + '/checkpoints/baggan/pidray_wrench_256/images/'
sample_labels = ROOT_DIR + '/checkpoints/baggan/pidray_wrench_256/labels.pt'

# Set this to the image index to be used for one-shot learning
one_shot_ind = 16

classes = ['background', 'wrench']
