...
model_path = ROOT_DIR + '/checkpoints/standard/car_512/stylegan2-car-config-f.pt'
...
sample_latents = ROOT_DIR + '/checkpoints/standard/car_512/latents.pt'
sample_labels  = ROOT_DIR + '/checkpoints/standard/car_512/labels.pt'
sample_images  = ROOT_DIR + '/checkpoints/standard/car_512/images/'
