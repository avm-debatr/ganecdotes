...
sample_latents = ROOT_DIR + '/checkpoints/standard/horse_256/latents.pt'
sample_images = ROOT_DIR + '/checkpoints/standard/horse_256/images/'
sample_labels = ROOT_DIR + '/checkpoints/standard/horse_256/labels.pt'
